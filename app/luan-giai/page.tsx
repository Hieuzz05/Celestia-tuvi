...
function TrangLuanGiai() {
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      // Không `|| 9`: giờ 0 (sinh sau nửa đêm, giờ Tý) từng bị đổi thành 9 giờ — giờ Tỵ
      gio: params.get('gio') !== null && Number.isInteger(Number(params.get('gio'))) ? Number(params.get('gio')) : 9,
