...
const PHU_TINH_EN: Record<string, string> = {
  ...
  // Bổ sung 20/09/2026 — khớp với bản tiếng Việt, xem ghi chú ở PHU_TINH_VI
  'Thái Tuế': 'this year you end up the one who has to speak, sign, or answer for something in front of others',
  'Thiếu Dương': 'good news or an invitation arrives earlier than you are ready for, usually through someone you know',
  'Tang Môn': 'you are likely to part with something, or see off someone, that has been with you a long while',
  'Thiếu Âm': 'things get settled quietly, with few people knowing, and you would rather not talk about it',
  'Quan Phù': 'paperwork, contracts, or one round of explaining yourself to a third party comes up',
  'Tử Phù': 'something in motion stops for good, and the hard part is accepting it will not restart',
  'Tuế Phá': 'a plan already set gets cut across midway, usually from outside rather than by you',
  'Long Đức': 'someone speaks up for you at the tightest moment, and it eases faster than you expected',
  'Bạch Hổ': 'things arrive fast and loud, and often have to be handled the same day rather than tomorrow',
  'Phúc Đức': 'family or someone older steps in, usually right when you have run out of room to move',
  'Điếu Khách': 'you get pulled into other people’s business — visiting, replying, standing in for someone',
  'Trực Phù': 'something has to happen on the exact day, with no moving it, even when you are busy elsewhere',
  'Bác Sĩ': 'people bring you their tangles to sort out, including things that are not your job',
  'Lực Sĩ': 'you carry several heavy things at once, and rarely mention that you are carrying them',
  'Thanh Long': 'there are stretches when things simply run: work lands, people fit, money arrives on time',
  'Tiểu Hao': 'money leaves in small amounts many times over, and you only notice at the end of the month',
  'Tướng Quân': 'once you start you finish, but you get short with anyone slower than you',
  'Tấu Thư': 'what you say and write carries weight, and you get picked to present for the group',
  'Phi Liêm': 'you are easily talked about behind your back, or misread through someone else’s retelling',
  'Hỷ Thần': 'a small good thing lands just as you are tired, usually from family rather than work',
  'Bệnh Phù': 'tiredness drags on longer than it should, and you tend to ignore it until you have to stop',
  'Đại Hao': 'a large sum leaves your hands in a short time, usually for something you cannot put off',
  'Phục Binh': 'someone holds back from saying it straight, so you find out later than you needed to',
  'Quan Phủ': 'you may have to settle right and wrong with someone in authority, from paperwork to an old promise',
  'Tam Thai': 'you get placed among the people with standing, even without asking for the seat',
  'Bát Tọa': 'your place in the group holds steady, even when things shift around you',
  'Thai Phụ': 'people with authority keep an eye on you, especially around study and exams',
  'Phong Cáo': 'what you did gets written down, not just spoken of',
  'Thiên Quan': 'you fit roles with clear duties, someone above to sign off, and rules to lean on',
  'Thiên Phúc': 'when things get hard there is usually a way back, and help comes from somewhere you did not expect',
  'Hoa Cái': 'you prefer working alone your own way, so you come across as distant without meaning to',
  'Thiên Tài': 'you pick up many different things quickly, but stop as soon as you know just enough',
  'Thiên Thọ': 'you can hold a steady routine for a long time, and recover faster than others your age',
  'Thiên Trù': 'food and a roof are rarely the problem, and you often get invited or looked after when it is tight',
  'Thiên Y': 'you know how to look after yourself, and get pointed to the right person at the right time',
  'Giải Thần': 'what looked serious tends to come undone at the last moment, sometimes from one well-placed word',
  'Thiên Giải': 'someone takes on the hardest part for you, and the weight lifts without you having to ask',
  'Địa Giải': 'a mess cools down on its own after a few days, as long as you do not force it while it is hot',
  'Thiên Đức': 'people give way to you, usually because you kept your word on something small',
  'Nguyệt Đức': 'a woman in the family or the team steps in exactly when you are running out',
  'Đường Phù': 'there are stretches of clear backing, when the work and the people line up for a short while',
  'Thiên La': 'you feel held in one place, wanting to move but unable to, usually because of an older tie',
  'Địa Võng': 'many small things pin you at once; untangle one and the next one holds',
  'Thiên Thương': 'you lose money or a person somewhere you had already put a lot of yourself',
  'Thiên Sứ': 'something arrives very suddenly, often just as you had decided everything was settled',
  'Lưu Hà': 'you run into something involving water, travelling, or one delay outside your control',
  'Đẩu Quân': 'one point in the year gathers everything up; get through that stretch and the rest is lighter',
  'LN Văn Tinh': 'this year study, exams, or writing show clearer results than anything else',
};
