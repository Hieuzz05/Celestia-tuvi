...
export const en: TuDien = {
  ...
  quickRead: {
    tieuDeChinh: 'Your chart',
    xemBan12Cung: 'See the 12-palace chart ↓',
    tieuDeCoTen: '{ten}’s chart',
    moTa: 'Start with the overview, then go deeper topic by topic.',
    ...
    tabChuyenSau: 'In depth',
    tabManhYeu: 'Strengths',
    tabLaSo: 'Chart',
    danhGiaTieuDe: 'The big picture',
    danhGiaMo: 'The 3 things Celes sees most clearly in your chart.',
    tiepTieuDe: 'Continue with the in-depth reading',
    tiepMo: 'Each topic is a few concrete questions about work, money, love, family… read from several palaces of your chart.',
    tiepCta: 'See the topics',
