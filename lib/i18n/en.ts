...
export const en: TuDien = {
  ...
  quickRead: {
    ...
    hoiThang: 'Ask Celes',
    sauNoiBatTieuDe: 'Read deeply into one thing on your mind',
    sauNoiBatMo: 'A long piece, roughly 1,500–2,000 words, written for this chart alone — work, money, relationships, family or health.',
    sauNoiBatCta: 'Read the deep interpretation',
    sauNoiBatHanMuc: 'One free reading a day.',
