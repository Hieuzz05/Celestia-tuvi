...
export const vi = {
  ...
  quickRead: {
    tieuDeChinh: 'Lá số của bạn',
    xemBan12Cung: 'Xem bàn 12 cung ↓',
    tieuDeCoTen: 'Lá số của {ten}',
    moTa: 'Đọc tổng quan trước, rồi đi sâu từng chủ đề hoặc xem lĩnh vực nào thuận lợi, lĩnh vực nào cần chăm chút.',
    ...
    tabChuyenSau: 'Chuyên sâu',
    tabManhYeu: 'Mạnh – yếu',
    tabLaSo: 'Lá số',
    danhGiaTieuDe: 'Đánh giá chung',
    danhGiaMo: '3 điểm chính Celes thấy rõ nhất trên lá số của bạn.',
    tiepTieuDe: 'Đọc tiếp phần chuyên sâu',
    tiepMo: 'Mỗi chủ đề là vài câu hỏi cụ thể về công việc, tiền bạc, tình cảm, gia đình… luận từ nhiều cung trên lá số.',
    tiepCta: 'Xem 14 chủ đề',
    tiepManhYeu: 'Hoặc xem điểm mạnh – điểm yếu',
    hoiTieuDe: 'Còn điều gì băn khoăn?',
    hoiMo: 'Hỏi Celes một câu của riêng bạn',
